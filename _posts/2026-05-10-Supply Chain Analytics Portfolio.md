...
<div class="sc-story">
  ...
  <p class="sc-story-text">
    ...
    Each project in this portfolio maps directly to a stage in the <a href="/posts/supply-chain-floor-to-forecast/" style="color:var(--link-color);text-decoration:none;font-weight:600;">Floor to Forecast roadmap ↗</a>. If you are following the roadmap, these are the deliverables.
  </p>
</div>
